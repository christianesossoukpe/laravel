...
@section('content')
<div class="max-w-md ml-[700px] p-6 bg-white shadow-lg rounded-lg mt-64 bg-[url('/public/images/')] bg-cover bg-center">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <p class="text-blue-500"> <a href="/login">Ou connectez-vous si vous avez de compte</a> </p>
    </form>
</div>
@endsection
