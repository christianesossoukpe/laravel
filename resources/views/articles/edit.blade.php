...
@section('content')
    <div class="container mx-auto p-10">
        <div class="bg-white shadow-md rounded-md overflow-hidden">
            <h3 class="text-2xl font-bold text-gray-800 mb-4">Modifier l'article</h3>
            ...
            <form action="{{ route('articles.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', $article->title) }}" class="w-full p-2 border border-gray-300 rounded-md">
                    @error('title')
                ...
                <div class="mb-4">
                    ...
                    <textarea id="summary" name="summary" rows="4" class="w-full p-2 border border-gray-300 rounded-md">{{ old('summary', $article->summary) }}</textarea>
                    @error('summary')
                        <div class="text-red-500 text-sm mt-2">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="file" id="file" name="file" class="w-full p-2 border border-gray-300 rounded-md">
                ...
                <div class="mt-4">
                    <button type="submit" class="bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600">Mettre à jour l'article</button>
                </div>
            </form>
        </div>
    </div>
