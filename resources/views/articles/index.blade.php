...
<nav class="   p-6" style="background-color: #FFB706;">
    <div class="container mx-auto flex justify-between items-center">
        <a href="/" class="text-white text-3xl  font-bold">ArticleMaster</a>
        <div>
    ...
    <!-- Grille des Articles -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 bg-blue-100 gap-6">
         ...
         class="h-full w-full">
                ...
                <div class="p-4">
                    ...
                    <div class="flex justify-between items-center">
                        <a href="{{ route('articles.show', $article->id) }}" class="bg-blue-700 
                         text-white px-4 py-2 rounded-lg hover:bg-blue-700">Voir l'article</a>
                    </div>
                </div>
            </div>
        @endforeach
